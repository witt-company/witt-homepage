...
export function Logo({
  ...
  const w1 = mono ? "currentColor" : "url(#witt-magenta)";
  const itt = mono ? "currentColor" : "#4e4b4a";
  const fold = mono ? "currentColor" : "url(#witt-blue)";
  const w2 = mono ? "currentColor" : "url(#witt-green)";
  ...
  return (
    ...
    >
      ...
      />
      <path fill={itt} d="M252.06,121.72h-24.55V16.35h24.55v105.37Z" />
      <path
        fill={itt}
